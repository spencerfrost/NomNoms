...
describe('RecipeBasicInfoForm', () => {
  ...
  it('renders all form fields correctly', () => {
    render(
      <RecipeBasicInfoForm formData={defaultFormData} onChange={mockOnChange} />
    )
  ...
  it('displays form data correctly', () => {
    ...
    render(
      <RecipeBasicInfoForm formData={filledFormData} onChange={mockOnChange} />
    )
  ...
  it('shows image preview when valid imageUrl is provided', () => {
    ...
    render(
      <RecipeBasicInfoForm formData={formDataWithImage} onChange={mockOnChange} />
    )
