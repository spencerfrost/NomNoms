      ...
      <div className="space-y-4">
        <div className="bg-gray-100 p-4 rounded">
          ...
          <div className="space-y-1 text-sm">
            ...
            <p><strong>DATABASE_URL (first 50 chars):</strong> {databaseUrl?.substring(0, 50)}...</p>
            <p><strong>Database Protocol:</strong> {databaseUrl?.split('://')[0]}</p>
            <p><strong>Is Prisma Accelerate?:</strong> {databaseUrl?.startsWith('prisma+postgres://') ? 'Yes' : 'No'}</p>
          </div>
        </div>
        ...
        <div className="bg-gray-100 p-4 rounded">
          ...
          <div className="space-y-1 text-sm">
            ...
            <p><strong>Sample Recipe Titles:</strong></p>
